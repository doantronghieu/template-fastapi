...
from app.integrations.livekit.service import get_room_service
from app.integrations.telnyx.client import get_telnyx_client
from app.integrations.telnyx.schemas.api import TelnyxWebhookData
...
@lru_cache(maxsize=1)
@require_module(ModuleType.INTEGRATIONS, "livekit")
