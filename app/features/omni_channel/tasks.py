...
from app.core.autodiscover import ModuleType, is_module_enabled
...
# =============================================================================
# Messenger Tasks (only registered when messenger integration is enabled)
# =============================================================================

if is_module_enabled(ModuleType.INTEGRATIONS, "messenger"):
    # Initialize channel message handlers when Celery loads this module
    from .workflows import initialize_channel_message_handlers
    ...
    def send_messenger_special_message(
        ...
        """
        # Lazy imports (messenger integration)
        from app.integrations.messenger import MessengerClient, format_messenger_message
        from app.integrations.messenger.config import messenger_settings
    ...
    # When messenger is disabled, provide empty __all__ to avoid import errors
    __all__ = []
